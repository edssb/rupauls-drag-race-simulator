...
let akashia = new Queen("Akashia", 3, 2, 7, 3, 2, 7, 10);
let bebe = new Queen("BeBe Zahara Benet", 7, 7, 7, 10, 7, 10, 7);
...
let rebecca = new Queen("Rebecca Glasscock", 3, 3, 6, 4, 2, 6, 6);
let shannel = new Queen("Shannel", 5, 5, 5, 9, 4, 9, 6);
...
let jujubee = new Queen("Jujubee", 9, 10, 8, 6, 10, 6, 14);
...
let sonique = new Queen("Sonique", 8, 7, 10, 9, 5, 9, 8);
let tatianna = new Queen("Tatianna", 8, 10, 7, 8, 10, 8, 10);
let tyra = new Queen("Tyra Sanchez", 9, 4, 7, 11, 3, 9, 9);
...
let manila = new Queen("Manila Luzon", 10, 9, 8, 11, 9, 10, 10);
...
let dida = new Queen("Dida Ritz", 6, 7, 7, 5, 7, 7, 10);
...
let milan = new Queen("Milan", 5, 5, 9, 6, 5, 8, 9);
let phiphi = new Queen("Phi Phi O'Hara", 9, 7, 8, 9, 9, 10, 8);
...
//SEASON 5:
let alaska = new Queen("Alaska", 10, 11, 7, 8, 9, 9, 9);
let alyssa = new Queen("Alyssa Edwards", 5, 9, 12, 5, 9, 7, 9);
let coco = new Queen("Coco Montrese", 4, 9, 9, 8, 6, 9, 14);
...
//SEASON 7:
let ginger = new Queen("Ginger Minj", 9, 10, 8, 7, 9, 7, 11);
...
let bob = new Queen("Bob The Drag Queen", 12, 14, 6, 6, 12, 7, 10);
...
let rajah = new Queen("Ra'Jah O'Hara", 7, 8, 10, 10, 6, 10, 12);
